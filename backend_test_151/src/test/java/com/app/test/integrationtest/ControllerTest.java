...
class ControllerTest {
  ...
  @AfterEach
  void  teardown() {
    jdbcTemplate.execute("DELETE FROM test.PetService");
    jdbcTemplate.execute("DELETE FROM test.PetOwner");
    jdbcTemplate.execute("DELETE FROM test.PetCareCenter");
    jdbcTemplate.execute("DELETE FROM test.Manager");
    jdbcTemplate.execute("DELETE FROM test.Document");
    jdbcTemplate.execute("DELETE FROM test.Pet");
     jdbcTemplate.execute("DELETE FROM test.PetCareCenterServices");
     jdbcTemplate.execute("DELETE FROM test.PetCareCenterBusinessHours");
     jdbcTemplate.execute("DELETE FROM test.PetOwnerPets");
     jdbcTemplate.execute("DELETE FROM test.PetCareCenterImages");
     jdbcTemplate.execute("DELETE FROM test.PetCareCenterPets");
